...
- Les fichiers modifiés doivent être stocker dans un nouveau dossier "cleaned" qui se situe au même niveau que le programma main.py et le dossier "speeches".
